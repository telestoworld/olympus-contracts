...
contract sTelesto is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Telesto", "sTELO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTELO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTELO
