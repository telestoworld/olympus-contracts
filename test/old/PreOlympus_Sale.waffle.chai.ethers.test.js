...
//         console.log( "Test::PreTelesto::beforeEach:01 deployer address is %s.", deployer.address );
//         console.log( "Test::PreTelesto::beforeEach:02 buyer1 address is %s.", buyer1.address );

//         console.log( "Test::PreTelesto::beforeEach:03 Loading PreTelestoToken." );
//         PreTelestoTokenContract = await ethers.getContractFactory("PreTelestoToken");

//         console.log( "Test::PreTelesto::beforeEach:04 Deploying PreTelestoToken." );
...
//         console.log( "Test::PreeTelestoSale::beforeEach:10 Deploying PreTelestoSales." );
//         sale = await PreTelestoSaleContract.connect( deployer ).deploy();
//         // await sale.deployed();
//         console.log( "Test::PreeTelestoSale:beforeEach:11 PreTelestoSale address is %s,", sale.address );
...
//             // console.log("Test::PreTelestoSaleDeployment::DeploymentSuccess: token name.");
